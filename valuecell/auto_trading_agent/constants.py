...
# Data requirements for technical analysis
DEFAULT_MIN_BARS_DAILY = 15  # Minimum bars for daily data (about 3 weeks of trading days)
DEFAULT_MIN_BARS_HOURLY = 50  # Minimum bars for hourly data (about 2-3 days)
